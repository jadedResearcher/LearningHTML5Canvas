...
function Plant(x,y,root, connectedToRoot, parent,canvas,context,block_size){
    ...
    this.randomGreen = function(){
        ...
        var green = Math.floor(Math.random()*100 + 155); //make mostly green if plant metaphor
    ...
    this.getColor = function(){
        ...
        if(this.root == true){
            return "#bfa27c";//make light brown if plant metaphor
        }else{
    ...
    this.render = function(){
        ...
        if(this.parent != null){
            ...
            this.context.lineWidth = Math.ceil(this.size/4);
            ...
            this.context.beginPath();
            this.context.fillStyle=color;
            this.context.fillRect(this.x,this.y,this.size/2,this.size/2);
        }
    ...
    this.tick = function(){
        ...
        if((this.root == true && this.age > 15) || this.connectedToRoot == false){
